  ...
  return (
    <Section id="about" title="About">
      <div className="space-y-4 text-slate-300">
        <p>
          I’m a Cloud Computing & Computer Science student who genuinely enjoys building things
          and understanding how they work end-to-end — from the code, to the infrastructure,
          to the data and monitoring behind it.
        </p>
        ...
        <p>
          ...
          the thinking part, the iteration, and the satisfaction of turning an idea into something usable.
        </p>
